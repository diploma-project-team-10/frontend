...
@Component({
  ...
  styleUrls: ['./view-company.component.scss', '../../../../reference/record/view-record/view-record.component.scss']
})
export class ViewCompanyComponent extends ViewRecordComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  async initRoute() {
    ...
    this.fieldsData = this.fieldService.getAllFields(CompanyFields, '{}');
  ...
  getEditUrl() {
    return ['/vertical/courses/admin/companies/edit', this.recordId];
  }
