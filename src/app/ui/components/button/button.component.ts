...
export class TCButtonComponent implements OnInit {
  ...
  @HostBinding('class.btn-accent-gradient')
  ...
  @HostBinding('class.btn-gradient') get gradientView() {
    return this.view === 'gradient';
  }
  @HostBinding('class.btn-br-line') get borderLineView() {
    return this.view === 'br-line';
  }
  @HostBinding('class.btn-br-lock') get borderLockView() {
    return this.view === 'br-lock';
  }
