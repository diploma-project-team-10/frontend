...
@Component({
  selector: 'tc-group-skills',
  templateUrl: './group-skills.component.html',
  styleUrls: ['./group-skills.component.scss']
})
export class TCGroupSkillsComponent implements OnInit {
  @HostBinding('class.tc-group-skills') true;
