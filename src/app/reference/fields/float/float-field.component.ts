...
@Component({
	selector: 'tc-float-field',
	templateUrl: './float-field.component.html',
	styleUrls: ['./float-field.component.scss'],
	providers: [
		{
			provide: NG_VALUE_ACCESSOR,
			useExisting: forwardRef(() => TCFloatFieldComponent),
			multi: true
		}
	]
})
export class TCFloatFieldComponent implements OnInit, OnChanges, ControlValueAccessor {
	@Input() align: string;
	@Input() title: string;
	@Input() type: string;
	@Input() isNew = false;
	...
	@Input() _valueField: FloatField = null;
